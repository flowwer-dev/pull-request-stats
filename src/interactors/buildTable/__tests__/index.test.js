...
const SIMPLE_RESPONSE = `|                                                                                                          | User  | Median time to review | Total reviews | Total comments |
| -------------------------------------------------------------------------------------------------------- | ----- | --------------------- | ------------- | -------------- |
...
const CHARTS_RESPONSE = `|                                                                                                          | User         | Median time to review | Total reviews      | Total comments     |
| -------------------------------------------------------------------------------------------------------- | ------------ | --------------------- | ------------------ | ------------------ |
...
const SORTED_RESPONSE = `|                                                                                                          | User  | Median time to review | Total reviews | Total comments |
| -------------------------------------------------------------------------------------------------------- | ----- | --------------------- | ------------- | -------------- |
| <a href=https://github.com/user2><img src="https://avatars.githubusercontent.com/u/5678" width="20"></a> | user2 | 2h 21m                | 1             | **5**          |
| <a href=https://github.com/user1><img src="https://avatars.githubusercontent.com/u/1234" width="20"></a> | user1 | **34m**               | **4**         | 1              |`;

const LINKS_RESPONSE = `|                                                                                                          | User  | Median time to review                                                                                                                                        | Total reviews | Total comments |
| -------------------------------------------------------------------------------------------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------- | -------------- |
...
const LINKS_AND_CHARTS_RESPONSE = `|                                                                                                          | User         | Median time to review                                                                                                                                               | Total reviews      | Total comments     |
| -------------------------------------------------------------------------------------------------------- | ------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------ | ------------------ |
